...
class App(QWidget):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon(os.path.join(resources_path, "icon.png")))
        ...
        self.intro_label.setStyleSheet("""
            ...
            font-weight: bold;
            padding: 10px;
            background: url("resources/background_image.png");
        ...
        # 设置初始图标为“隐藏密码”图标
        self.show_password_button.setIcon(QIcon("resources/pswd_hide.png"))
    ...
    def toggle_password_visibility(self):
        ...
        if self.password_input.echoMode() == QLineEdit.Password:
            ...
            self.show_password_button.setIcon(QIcon("resources/pswd_show.png"))  # 更新按钮文本为 "Hide"
        else:
            self.password_input.setEchoMode(QLineEdit.Password)  # 隐藏密码
            self.show_password_button.setIcon(QIcon("resources/pswd_hide.png"))  # 更新按钮文本为 "Show"
